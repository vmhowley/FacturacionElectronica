import { FilePlus, FileText, LayoutDashboard, LogOut, Package, Settings, Users } from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-50 font-['Inter']">
            ...
            <aside className="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col">
                ...
                <nav className="flex-1 px-4 space-y-2 mt-4">
                    ...
                    >
                        <LayoutDashboard size={20} className={isActive('/') ? 'text-blue-600' : 'text-gray-400 group-hover:text-gray-600'} />
